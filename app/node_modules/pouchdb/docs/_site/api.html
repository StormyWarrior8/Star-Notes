...
<li><code>options.auto_compaction</code>: This turns on auto compaction (experimental). Defaults to <code>false</code>.</li>
...
<p>Triggers a compaction operation for <code>db</code> on the remote host. This reduces the database&#39;s size by removing unused and old data. If a <code>callback</code> function is specified, Pouch checks compaction status at regular intervals and fires the callback upon completion. Consult the <a href="http://couchdb.readthedocs.org/en/latest/maintenance/compaction.html">compaction section of CouchDB&#39;s maintenance documentation</a> for more detail about database compaction.</p>

<p><strong>Note:</strong> This method is only available when using the http adapter.</p>
