...
<html lang="en">
  ...
  <head>
    ...
    <title>Welcome to the PouchDB blog</title>
    ...
    <header>
      ...
      <div class="page-head">
        ...
        <div class="container">
          ...
          <h1>Welcome to the PouchDB blog</h1>
...
<div class="post">
  <div class="media">
    ...
    <p>
      ...
      <p>Hello World! Welcome to the newly formed PouchDB blog. PouchDB has been an active community for over 2 years now, with almost everything being run via IRC and Github. As the project grows, we wanted a way to communicate with users about the current state of the PouchDB world.</p>

<p>We will obviously be posting updates and releases notes for PouchDB releases, but as well as that, we will also be blogging about related projects and technologies within the PouchDB world, such as Service Workers, CouchDB, etc.</p>

<p>As with the PouchDB source, we would love to invite everyone to contribute.  We have <a href="https://github.com/daleharvey/pouchdb/blob/master/CONTRIBUTING.md#writing-a-pouchdb-blog-post">documented the instructions</a>, so please get involved.</p>

<p>Over the last 4 years PouchDB has had 89 <a href="https://github.com/daleharvey/pouchdb/graphs/contributors">awesome contributors</a>. I would like to give a shout-out to the people who worked together to get this site up and running in such a short time: <a href="https://twitter.com/NickColley">nickcolley</a>, <a href="https://twitter.com/misosoup">misosoup</a>, <a href="https://twitter.com/zaccolley">zaccolley</a>, <a href="https://twitter.com/nolanlawson">nolanlawson</a> and <a href="https://github.com/virgie">virgie</a> in particular.</p>
